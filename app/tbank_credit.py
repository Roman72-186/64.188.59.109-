...
Webhook: URL передаётся в Create (параметр webhookURL). Тело не подписано (в отличие от
Т-Банка эквайринга) — источник истины: GET /info. Аутентичность отправителя — по IP.
"""
