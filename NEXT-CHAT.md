...
- **ДВА УСЛОВИЯ ДО ПЕРВОГО РЕАЛЬНОГО КРЕДИТНОГО ЗАКАЗА (≥3108 ₽):**
  1. Подтвердить, что Т-Банк по POS-кредитованию (showcaseId `1c9fa012-...`) НЕ
     фискализирует чек сам — иначе двойной чек (мы + Т-Банк). Дока Т-Банка двусмысленна:
     API-страница говорит «система сделает сама», страница про чек — «интернет-магазин
     может пробить через сервис фискализации». Решено: фискализируем мы.
