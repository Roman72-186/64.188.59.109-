...
**ДЕПЛОЙ ВЫПОЛНЕН (08.06.2026).** Код на сервере 64.188.59.109 (58 тестов), сертификат mTLS
...
плательщик. Документация (README/CLAUDE/DOCS/PRD/config.example) актуализирована под
мультипровайдерный подход. TODO: ротировать боевые креды Долями у менеджера. Детали — в
разделе «Уточнения» выше.
